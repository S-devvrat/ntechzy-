    ...
    <section className="relative w-full min-h-screen bg-[#0a0a0a] text-white overflow-hidden flex items-center justify-center px-6 md:px-24 mt-16 md:mt-6">
      ...
      <div className="relative z-10 max-w-6xl w-full flex flex-col md:flex-row-reverse items-center gap-12">
        ...
        <div className="order-2 md:order-1 w-full md:w-1/2 flex justify-center">
          <div className="relative bg-gradient-to-br from-[#3e2b77] to-[#8a63d2] p-[1px] rounded-2xl w-full max-w-sm shadow-2xl transition duration-300 group hover:shadow-[0_0_30px_#8a63d2]">
            <div className="bg-[#0a0a0a] rounded-2xl px-8 py-10 h-full transition-transform group-hover:scale-[1.02]">
        ...
        {/* Left Content */}
        <div className="order-1 md:order-2 w-full md:w-1/2 text-center md:text-left space-y-6 items-center md:items-start">
          {/* Badge */}
